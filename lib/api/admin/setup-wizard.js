...
function getRunSetupChecks() {
  return require("../../automation/setup-checks").runSetupChecks;
}

function getRunAutomationTest() {
  return require("../../automation/test-mode-runner").runAutomationTest;
}

function getCleanupAutomationTestRun() {
  return require("../../automation/test-cleanup").cleanupAutomationTestRun;
}
