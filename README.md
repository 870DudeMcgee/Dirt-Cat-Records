...
- The homepage phone hero now uses a dedicated compact stack: the logo sits inline above the offer copy, the heading and CTA scale to the viewport, and the opened hamburger menu uses a vertical neon signal list so iPhone Safari does not bury the hero behind clunky navigation chrome.
