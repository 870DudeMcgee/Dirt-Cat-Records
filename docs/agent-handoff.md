...
The top-level README is now a reader-oriented project front door with feature groups, architecture flow, prerequisites, environment profile summary, command table, deployment summary, grouped documentation links, and safety notes. Keep detailed operator instructions in `docs/operator-guide.md`.
