...
- **Authoritative project identity and state:** Supabase identified the same ref `ossprdfycpdvewpxtsfw` as an existing project, initially with status `INACTIVE`. This proved that restore, rather than reprovisioning, was the correct recovery path.
